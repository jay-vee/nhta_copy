...
Public Class ScoringSummaryWebFormat
    ...
    Public Sub SetDataGrid(ByVal e As System.Web.UI.WebControls.DataGridItemEventArgs, Optional ByVal SeparateByProductionType As Boolean = True)
        ...
        Dim sTableString As New StringBuilder
        '====================================================================================================
            ...
            Select Case e.Item.ItemType.ToString
                ...
                Case Else
                    ...
                    If (SeparateByProductionType = True And (Not ProductionType = e.Item.Cells(2).Text)) Or (Not ProductionCategory = e.Item.Cells(1).Text) Or (Not CategoryType = e.Item.Cells(7).Text) Then
                        ...
                        sTableString.Append("<table cellspacing=0 cellpadding=0 style=""width:1000px;color: Black; font-family: Verdana; font-size: 11;""><tr><td colspan=99 style=""color: Black; font-family: Verdana; font-size:x-large ; text-decoration: underline;"">Best " & CategoryName & "<i>" & e.Item.Cells(2).Text & "</i> " & e.Item.Cells(1).Text & "</td></tr><tr>")
                    Else
                        sTableString.Append("<tr>")
                    End If

                    sTableString.Append("<td style=""color: Black; font-family: Verdana; font-size: 11;;width:100%; white-space:nowrap"" colspan=99>" & Title & " - <i>" & CompanyName & "</i>")       'Company Name

                    If BestName = BestRole Then
                        'sTableString.Append("")                                                                    'dont display Best Name
                    Else

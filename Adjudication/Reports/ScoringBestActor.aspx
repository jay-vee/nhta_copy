<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ScoringBestActor.aspx.vb" Inherits="Adjudication.ScoringBestActor" %>
<!DOCTYPE html>
<HTML>
	<HEAD>
	...
	<body >
		<form class="container" class="fontData" id="MainMenu" method="post" runat="server">
			<table cellSpacing="0" cellPadding="0" width="800">
				<tr>
					<td class="ReportHeader800" align="center" colSpan="3" height="30">Best Actor 
						Scoring
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td class="fontData" vAlign="top" align="left" width="800" colSpan="2"><asp:panel id="pnlGrid" runat="server">
							<TABLE id="tblMain" cellSpacing="0" cellPadding="0" width="800" border="0">
								...
								<TR>
									<TD class="fontDataHeader" align="left" width="240">Best Actor</TD>

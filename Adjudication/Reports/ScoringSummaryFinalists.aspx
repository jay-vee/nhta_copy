<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ScoringSummaryFinalists.aspx.vb" Inherits="Adjudication.ScoringSummaryFinalists" %>
                ...
                <table cellspacing="0" cellpadding="0" style="width: 100%; height: 60px; border: none">
                    <tr>
                        <td style="font-size: x-large; color: Black; font-family: Arial; font-variant: small-caps; white-space: nowrap" align="center">
                            ...
                            <asp:Label ID="lblProductionCategory" runat="server"></asp:Label>Finalists
                        </td>
                    </tr>
                    <tr>
                        <td align="center" style="font-size: x-small; font-variant: small-caps; font-style: italic">
                            <asp:Label ID="lblSortOrder" runat="server" Style="color: #808080">Finalists are listed XXX by XXX</asp:Label>

            ...
            Select Case e.Item.ItemType.ToString
                ...
                Case Else
                    ...
                    If (SeparateByProductionType = True And (Not ProductionType = e.Item.Cells(2).Text)) Or (Not ProductionCategory = e.Item.Cells(1).Text) Or (Not CategoryType = e.Item.Cells(7).Text) Then
                        ...
                        If Not ProductionCategory = "" Then sTableString.Append("<hr style=""color:#ffcc00;"" size=""1"" /><br />")
                        ...
                        sTmp = "<div style=""color: Black; font-family: Verdana; font-size:medium; font-variant: small-caps; text-decoration: underline;"">" & _
                                    "Best " & CategoryName & "<i>" & e.Item.Cells(2).Text & "</i> " & e.Item.Cells(1).Text & "</div>"
                        sTableString.Append(sTmp)
                    End If

                    sTmp = "<div style=""width:100%; color: Black; font-family: Verdana; font-size: smaller ;white-space:nowrap"">" & _
                            Title & " - <i>" & CompanyName & "</i>"       'Company Name
                    sTableString.Append(sTmp)


                    If Not BestName = BestRole Then
                        If BestRole = CategoryName Then
                            sTableString.Append(" (<b>" & BestName & "</b>)")                                           'Best Name
                        Else

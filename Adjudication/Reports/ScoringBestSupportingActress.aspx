<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ScoringBestSupportingActress.aspx.vb" Inherits="Adjudication.ScoringBestSupportingActress" %>
<!DOCTYPE html>
<HTML>
	<HEAD>
	...
	<body >
		<form class="container" class="fontData" id="MainMenu" method="post" runat="server">
			<table cellSpacing="0" cellPadding="0" width="800">
				<tr>
					<td class="ReportHeader800" align="center" colSpan="3" height="30">Best Supporting 
						Actress Scoring
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td class="fontData" vAlign="top" align="left" width="800" colSpan="2"><asp:panel id="pnlGrid" runat="server">
							<TABLE id="tblMain" cellSpacing="0" cellPadding="0" width="800" border="0">
								...
								<TR>
									<TD class="fontDataHeader" align="left" width="240">Best Supporting Actress</TD>
									...
									<TD colSpan="8">
										<asp:datagrid id="gridMain" runat="server" AutoGenerateColumns="False" CssClass="fontDatasmall"
											...
											<Columns>
												...
												<asp:BoundColumn Visible="False" DataField="BestRole" HeaderText="BestRole"></asp:BoundColumn>
												...
												<asp:TemplateColumn>
													<ItemTemplate>
														<table width="800" class="fontData" cellpadding="0" cellspacing="0" align="left">
															...
															<tr>
																<td width="240" align="left" class="fontDatasmall"><I>as "<%# DataBinder.Eval(Container.DataItem, "BestRole") %>"</I></td>

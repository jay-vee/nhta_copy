<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ScoringBestSupportingActor.aspx.vb" Inherits="Adjudication.ScoringBestSupportingActor" %>
<!DOCTYPE html>
<HTML>
	<HEAD>
				...
				<tr>
					<td class="fontData" vAlign="top" align="left" width="800" colSpan="2"><asp:panel id="pnlGrid" runat="server">
							<TABLE id="tblMain" cellSpacing="0" cellPadding="0" width="800" border="0">
								...
								<TR>
									<TD class="fontDataHeader" align="left" width="240">Best Supporting Actor</TD>

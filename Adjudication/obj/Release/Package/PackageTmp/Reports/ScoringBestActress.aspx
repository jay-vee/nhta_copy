<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ScoringBestActress.aspx.vb" Inherits="Adjudication.ScoringBestActress" %>
<!DOCTYPE html>
<HTML>
	<HEAD>
	...
	<body >
		<form class="container" class="fontData" id="MainMenu" method="post" runat="server">
			<table cellSpacing="0" cellPadding="0" width="800">
				<tr>
					<td class="ReportHeader800" align="center" colSpan="3" height="30">Best Actress 
						Scoring
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td class="fontData" vAlign="top" align="left" width="800" colSpan="2"><asp:panel id="pnlGrid" runat="server">
							<TABLE id="tblMain" cellSpacing="0" cellPadding="0" width="800" border="0">
								...
								<TR>
									<TD class="fontDataHeader" align="left" width="240">Best Actress</TD>
								...
								<TR>
									<TD colSpan="8">
										<asp:datagrid id="gridMain" runat="server" HorizontalAlign="Left" CellSpacing="0" CellPadding="0"
											...
											BorderStyle="None" Width="800px" CssClass="fontDatasmall" AutoGenerateColumns="False">
											...
											<Columns>
												...
												<asp:BoundColumn Visible="False" DataField="BestPerformerName" HeaderText="BestPerformerName"></asp:BoundColumn>
												<asp:BoundColumn Visible="False" DataField="BestPerformerRole" HeaderText="BestPerformerRole"></asp:BoundColumn>
														...
														<table width="800" class="fontData" cellpadding="0" cellspacing="0" align="left">
															...
															<tr>
																<td width="240" align="left">
																	<%# DataBinder.Eval(Container.DataItem, "BestPerformerName") %>
																</td>
																<td width="240" align="left">
															...
															<tr>
																<td width="240" align="left" class="fontDatasmall"><I>as "<%# DataBinder.Eval(Container.DataItem, "BestPerformerRole") %>"</I></td>
								...
								<TR>
									<TD class="fontHeaderLight" align="right" bgColor="lightgoldenrodyellow" colSpan="8">
										<asp:Label id="lblLastScore" CssClass="fontData" Runat="server" Visible="False"></asp:Label></TD>
								</TR>
								<TR>
